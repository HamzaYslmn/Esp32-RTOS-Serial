...
// Task 2: Print system info every 1.5 seconds
void task2(void* parameter) {
  while (true) {
    rtosPrintf("Task 2 - Free heap: %d bytes", ESP.getFreeHeap());
...
void setup() {
  ...
  rtosPrintln("- Task 2: Memory info every 1.5 seconds");
  rtosPrintln("- Task 3: Echo user input");
  rtosPrintln("Type something to test Task 3");
  rtosPrintln("============================================");
